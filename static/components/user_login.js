...
const user_login = {
	...
	<div class="box">
	  <div class="login_form"><br><br><br>
	    <h1 style="text-align: center;"> Login to Harmonix </h1>
	    ...
	    <p style="text-align: center;" class="text-muted">Don't have an account? <router-link to="/user/signup"> Sign Up. </router-link></p><br>
	</div>
	...
	methods: {
		async submit(){
			...
			if (result.status_code === 200) {
				...
				if (result.role == 'User' || result.role == 'Creator') {
		    		router.push('/user');
