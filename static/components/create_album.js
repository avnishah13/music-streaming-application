...
const create_album = {
	  ...
	  <div class="container-fluid">
	    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
	      <ul class="navbar-nav mr-auto">
	        ...
	        <router-link class="navbar-brand" to="/creator" style="font-size: 30px;">&nbsp;Harmonix</a>
	...
	<div class="login_form">
	  <h1> Create Album </h1>
	  <form @submit.prevent="submit" action="/creator/album" method="POST" enctype="multipart/form-data">
	    <fieldset>

	      <div class="form-group">
	        <label for="album_name" class="form-label mt-4">Album Name</label>
	        <input class="form-control" id="album_name" placeholder="Reputation" name="album_name" style="width: 600px; margin: 10px auto;" required>
	      </div>

	      <div>
	        <label for="image" class="form-label mt-4">Image</label>
	        <input class="form-control" type="file" id="image" name="image" accept="image/*" @change="uploaded($event)" style="width: 600px; margin: 10px auto;" required>
	      </div>

	      <div class="form-group">
	        <label for="exampleSelect1" class="form-label mt-4">Language</label>
	...
	methods: {
		async submit(){
			...
			if (result.status_code === 200) {
	    		router.push({
		    		name: 'creator_home',
					query: { message: 'Album added successfully!' }
	    		});
